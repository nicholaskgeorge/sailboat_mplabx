...
${OBJECTDIR}/_ext/60181018/plib_spi0.o: ../src/config/default/peripheral/spi/plib_spi0.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/60181018" 
	@${RM} ${OBJECTDIR}/_ext/60181018/plib_spi0.o.d 
	@${RM} ${OBJECTDIR}/_ext/60181018/plib_spi0.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -O1 -I"../src" -I"../src/config/default" -I"../src/packs/ATSAME70Q21B_DFP" -I"../src/packs/CMSIS/CMSIS/Core/Include" -I"../src/packs/CMSIS/" -I"../src/config/default/system/fs/fat_fs/file_system" -I"../src/config/default/system/fs/fat_fs/hardware_access" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/60181018/plib_spi0.o.d" -o ${OBJECTDIR}/_ext/60181018/plib_spi0.o ../src/config/default/peripheral/spi/plib_spi0.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}/same70b" ${PACK_COMMON_OPTIONS} 
	@${FIXDEPS} "${OBJECTDIR}/_ext/60181018/plib_spi0.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
